...
if (isset($_POST['create_user'])) {
    ...
    else
    {
        ...
        {
            $conn->query("INSERT INTO `mythicalwebpanel_users` (`email`, `username`, `first_name`, `last_name`, `password`, `api_key`) VALUES ('".$email."', '".$username."', '".$firstName."', '".$lastName."', '".$password."', '".$skey."');");
